...
.setColor("127896")
.setAuthor({ name: `MCFG | Destek Sistemi`, iconURL: as.guild.iconURL({ dynamic: true }) })
...
.addFields(
     ...
     { name: "**☢️ Genel Destek **", value: "Sunucumuzda Genel Destek Almak İçin.", inline: true },
...
const butonlar = ["Çekiliş Kazandım","Genel Destek","Kullanıcı Bildirimi"]
...
const embed = new EmbedBuilder()
.setAuthor({name: "MCFG - Destek Sistemi!", iconURL: interaction.guild.iconURL()})
